...
/**
 * REST controller for managing {@link team.bham.domain.Article}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Article> result = articleRepository
            ...
            .map(existingArticle -> {
                ...
                if (article.getContentType() != null) {
                    existingArticle.setContentType(article.getContentType());
                }
                if (article.getSourceLink() != null) {
                    existingArticle.setSourceLink(article.getSourceLink());
                }
                if (article.getThumbnail() != null) {
                    existingArticle.setThumbnail(article.getThumbnail());
                }
                if (article.getThumbnailContentType() != null) {
                    existingArticle.setThumbnailContentType(article.getThumbnailContentType());
                }
