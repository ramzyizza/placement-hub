...
## This repository belongs to team 8
...
`% java --version openjdk 11.0.17 2022-10-18` [Download](https://www.openlogic.com/openjdk-downloads?field_java_parent_version_target_id=406&field_operating_system_target_id=All&field_architecture_target_id=All&field_java_package_target_id=396&page=1) Scroll down for 11.0.17

`% mvn -version Apache Maven 3.9.4` [Download](https://dlcdn.apache.org/maven/maven-3/3.9.4/binaries/) Installation instructions inside ReadME

`% npm -version 8.19.3`

`% node --version v18.13.0` [Download](https://nodejs.org/dist/v18.13.0/) Download Darwin version for MacOS X
